...
setup() {
    ...
    # Extracted-function sourcing breaks BASH_SOURCE resolution; point directly
    # at the plugin skills directory.
    PIPELINE_SKILLS_DIR="$CLAUDE_PROJECT_DIR/plugins/pipeline-core/skills"
    export PIPELINE_SKILLS_DIR
