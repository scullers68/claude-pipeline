...
#
# Output:
#   $SCRIPT_DIR/implement-issue-test/fixtures/usage-response.json
#
# Usage:
#   $SCRIPT_DIR/capture-usage-fixture.sh                     # interactive prompts
#   CLAUDE_USAGE_SESSION_KEY=sk-ant-... CLAUDE_USAGE_ORG_ID=uuid \
#     $SCRIPT_DIR/capture-usage-fixture.sh                   # fully scripted
#
# Security notes:
