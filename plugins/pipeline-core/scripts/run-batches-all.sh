...
#   2. $SCRIPT_DIR/batch-orchestrator.sh --issues "..." --branch main
#   3. $SCRIPT_DIR/post-batch-validate.sh --batch N
#
# Stops on first non-zero exit and prints a summary.
#
# Usage:
#   $SCRIPT_DIR/run-batches-all.sh
#   $SCRIPT_DIR/run-batches-all.sh --start-batch 7
#   $SCRIPT_DIR/run-batches-all.sh --help
#
# Exit codes:
