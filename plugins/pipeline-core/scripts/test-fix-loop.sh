...
#
# Usage:
#   $SCRIPT_DIR/test-fix-loop.sh
#   $SCRIPT_DIR/test-fix-loop.sh --test-file tests/e2e/molesworth-farmer-journey.spec.ts
#   $SCRIPT_DIR/test-fix-loop.sh --max-iterations 5 --max-attempts-per-ac 2
#   $SCRIPT_DIR/test-fix-loop.sh --branch feature/issue-679
#
# Outputs:
