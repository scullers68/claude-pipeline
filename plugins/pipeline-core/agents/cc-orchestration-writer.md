...
its system prompt — agent `.md` files in `${CLAUDE_PLUGIN_ROOT}/agents/` are the bash-friendly equivalent of
skill composition.
...
- `${CLAUDE_PLUGIN_ROOT}/scripts/implement-issue-orchestrator.sh` - Reference implementation
- `${CLAUDE_PLUGIN_ROOT}/scripts/implement-issue-test/` - Reference test suite
