...
# using-skills ships via the superpowers plugin now; inject only if a local copy exists.
using_skills_content=$(cat "${SCRIPT_DIR}/../../skills/using-skills/SKILL.md" 2>/dev/null || true)
